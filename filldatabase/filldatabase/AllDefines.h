...
#define SINGLE_PLIST_PATH [DOCUMENTS_DIRECTORY stringByAppendingPathComponent:@"notes.plist"]
#define SINGLE_PLIST_BINARY_PATH [DOCUMENTS_DIRECTORY stringByAppendingPathComponent:@"notesBinary.plist"]
...
#define MULTIPLE_PLIST_FOLDER [DOCUMENTS_DIRECTORY stringByAppendingPathComponent:@"Notes"]
#define MULTIPLE_BINARY_PLIST_FOLDER [DOCUMENTS_DIRECTORY stringByAppendingPathComponent:@"BinaryNotes"]
#define NOTES_COUNT @1000
// мой, huge, testmega,
