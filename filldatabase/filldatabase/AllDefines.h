...
#define CREATE_NOTE_TABLE_QUERY @"CREATE TABLE IF NOT EXISTS note (_id INTEGER PRIMARY KEY AUTOINCREMENT, ID TEXT UNIQUE NOT NULL, type TEXT, ownerID TEXT, status INTEGER, shared INTEGER, smart_enabled INTEGER, history TEXT, relations TEXT, message TEXT, complete TEXT, event_enable TEXT, event_start_TS TEXT, event_end_TS TEXT, event_tz_name TEXT, event_alarms TEXT, event_repeat_type INTEGER, event_repeat_expDay INTEGER, event_repeat_rules TEXT, event_repeat_exceptions TEXT, event_geo_lat TEXT, event_geo_lng TEXT, event_geo_acc TEXT, event_geo_TS TEXT, event_geo_inf_address TEXT, event_geo_inf_country TEXT, event_geo_inf_administrative_area_level_1 TEXT, event_geo_inf_locality TEXT, event_geo_inf_rouevent_geote TEXT, event_geo_inf_street_number TEXT, event_geo_inf_postal_code TEXT, pwd TEXT, smart TEXT, attachments TEXT, create_TS INTEGER, create_srvTS INTEGER, create_devID TEXT, create_geo_lat TEXT, create_geo_lng TEXT, create_geo_acc TEXT, create_geo_inf_address TEXT, create_geo_inf_street_number TEXT, create_geo_inf_administrative_area_level_1 TEXT, create_geo_inf_country TEXT, create_geo_inf_locality TEXT, create_geo_inf_postal_code TEXT, create_geo_inf_route TEXT, modify_TS INTEGER, modify_srvTS INTEGER, modify_devID TEXT, modify_geo_lat TEXT, modify_geo_lng TEXT, modify_geo_acc TEXT, modify_geo_inf_address TEXT, modify_geo_inf_country TEXT, modify_geo_inf_administrative_area_level_1 TEXT, modify_geo_inf_locality TEXT, modify_geo_inf_route TEXT, modify_geo_inf_street_number TEXT, modify_geo_inf_postal_code TEXT, strucVer INTEGER, is_cached INTEGER, is_draft INTEGER, sync INTEGER, cmdTS TEXT, meta TEXT);"
